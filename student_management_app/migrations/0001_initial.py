# Generated by Django 3.2.25 on 2026-03-26 17:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.FileField(blank=True, null=True, upload_to='student_profile_pics/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('profile_pic', models.FileField(blank=True, null=True, upload_to='staff_profile_pics/')),
                ('address', models.TextField(blank=True)),
                ('admin', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
